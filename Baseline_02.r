...
# pmyexp <- "CA0001_BaselineR02"
# pinputexps <- "DT0002_BaselineR02"
# pserver <- "local"
...
# pmyexp <- "DR0001_BaselineR02"
# pinputexps <- "CA0001_BaselineR02"
# pserver <- "local"
...
# pmyexp <- "FE0001_BaselineR02"
# pinputexps <- "DR0001_BaselineR02"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR02", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR02", "DT0001_BaselineR02" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR02", "CA0001_BaselineR02" )
  FE_historia_guantesblancos( "FE0001_BaselineR02", "DR0001_BaselineR02" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BaselineR02", "FE0001_BaselineR02" )
  
  HT_tuning_guantesblancos( "HT0001_BaselineR02", "TS0001_BaselineR02" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BaselineR02", c("HT0001_BaselineR02","TS0001_BaselineR02") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BaselineR02", "FE0001_BaselineR02" )
  
  HT_tuning_guantesblancos( "HT0002_BaselineR02", "TS0002_BaselineR02" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BaselineR02", c("HT0002_BaselineR02", "TS0002_BaselineR02") )
...
corrida_guantesblancos_202109( "gb01_BaselineR02" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BaselineR02" )