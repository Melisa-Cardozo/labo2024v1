...
# pmyexp <- "CA0001_baseline02final"
# pinputexps <- "DT0002_baseline02final"
# pserver <- "local"
...
# pmyexp <- "DR0001_baseline02final"
# pinputexps <- "CA0001_baseline02final"
# pserver <- "local"
...
# pmyexp <- "FE0001_baseline02final"
# pinputexps <- "DR0001_baseline02final"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_baseline02final", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_baseline02final", "DT0001_baseline02final" )
  
  DR_drifting_guantesblancos( "DR0001_baseline02final", "CA0001_baseline02final" )
  FE_historia_guantesblancos( "FE0001_baseline02final", "DR0001_baseline02final" )
  
  TS_strategy_guantesblancos_202109( "TS0001_baseline02final", "FE0001_baseline02final" )
  
  HT_tuning_guantesblancos( "HT0001_baseline02final", "TS0001_baseline02final" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_baseline02final", c("HT0001_baseline02final","TS0001_baseline02final") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_baseline02final", "FE0001_baseline02final" )
  
  HT_tuning_guantesblancos( "HT0002_baseline02final", "TS0002_baseline02final" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_baseline02final", c("HT0002_baseline02final", "TS0002_baseline02final") )
...
corrida_guantesblancos_202109( "gb01_baseline02final" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_guantesblancos_202107( "gb02_baseline02final" )
