...
# pmyexp <- "CA0001_Baseline07SI"
# pinputexps <- "DT0002_Baseline07SI"
# pserver <- "local"
...
# pmyexp <- "DR0001_Baseline07SI"
# pinputexps <- "CA0001_Baseline07SI"
# pserver <- "local"
...
# pmyexp <- "FE0001_Baseline07SI"
# pinputexps <- "DR0001_Baseline07SI"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_Baseline07SI", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_Baseline07SI", "DT0001_Baseline07SI" )
  
  DR_drifting_guantesblancos( "DR0001_Baseline07SI", "CA0001_Baseline07SI" )
  FE_historia_guantesblancos( "FE0001_Baseline07SI", "DR0001_Baseline07SI" )
  
  TS_strategy_guantesblancos_202109( "TS0001_Baseline07SI", "FE0001_Baseline07SI" )
  
  HT_tuning_guantesblancos( "HT0001_Baseline07SI", "TS0001_Baseline07SI" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_Baseline07SI", c("HT0001_Baseline07SI","TS0001_Baseline07SI") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_Baseline07SI", "FE0001_Baseline07SI" )
  
  HT_tuning_guantesblancos( "HT0002_Baseline07SI", "TS0002_Baseline07SI" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_Baseline07SI", c("HT0002_Baseline07SI", "TS0002_Baseline07SI") )
...
#corrida_guantesblancos_202109( "gb01_Baseline07SI" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_Baseline07SI" )
