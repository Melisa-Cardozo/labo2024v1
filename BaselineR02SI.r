...
# pmyexp <- "CA0001_Baseline020202"
# pinputexps <- "DT0002_Baseline020202"
# pserver <- "local"
...
# pmyexp <- "DR0001_Baseline020202"
# pinputexps <- "CA0001_Baseline020202"
# pserver <- "local"
...
# pmyexp <- "FE0001_Baseline020202"
# pinputexps <- "DR0001_Baseline020202"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_Baseline020202", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_Baseline020202", "DT0001_Baseline020202" )
  
  DR_drifting_guantesblancos( "DR0001_Baseline020202", "CA0001_Baseline020202" )
  FE_historia_guantesblancos( "FE0001_Baseline020202", "DR0001_Baseline020202" )
  
  TS_strategy_guantesblancos_202109( "TS0001_Baseline020202", "FE0001_Baseline020202" )
  
  HT_tuning_guantesblancos( "HT0001_Baseline020202", "TS0001_Baseline020202" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_Baseline020202", c("HT0001_Baseline020202","TS0001_Baseline020202") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_Baseline020202", "FE0001_Baseline020202" )
  
  HT_tuning_guantesblancos( "HT0002_Baseline020202", "TS0002_Baseline020202" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_Baseline020202", c("HT0002_Baseline020202", "TS0002_Baseline020202") )
...
#corrida_guantesblancos_202109( "gb01_Baseline020202" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_Baseline020202" )
