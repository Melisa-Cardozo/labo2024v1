...
# pmyexp <- "CA0001_BaselineR06SI"
# pinputexps <- "DT0002_BaselineR06SI"
# pserver <- "local"
...
# pmyexp <- "DR0001_BaselineR06SI"
# pinputexps <- "CA0001_BaselineR06SI"
# pserver <- "local"
...
# pmyexp <- "FE0001_BaselineR06SI"
# pinputexps <- "DR0001_BaselineR06SI"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR06SI", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR06SI", "DT0001_BaselineR06SI" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR06SI", "CA0001_BaselineR06SI" )
  FE_historia_guantesblancos( "FE0001_BaselineR06SI", "DR0001_BaselineR06SI" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BaselineR06SI", "FE0001_BaselineR06SI" )
  
  HT_tuning_guantesblancos( "HT0001_BaselineR06SI", "TS0001_BaselineR06SI" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BaselineR06SI", c("HT0001_BaselineR06SI","TS0001_BaselineR06SI") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BaselineR06SI", "FE0001_BaselineR06SI" )
  
  HT_tuning_guantesblancos( "HT0002_BaselineR06SI", "TS0002_BaselineR06SI" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BaselineR06SI", c("HT0002_BaselineR06SI", "TS0002_BaselineR06SI") )
...
#corrida_guantesblancos_202109( "gb01_BaselineR06SI" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BaselineR06SI" )
