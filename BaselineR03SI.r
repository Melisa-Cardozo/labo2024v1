...
# pmyexp <- "CA0001_BaselineR03SI"
# pinputexps <- "DT0002_BaselineR03SI"
# pserver <- "local"
...
# pmyexp <- "DR0001_BaselineR03SI"
# pinputexps <- "CA0001_BaselineR03SI"
# pserver <- "local"
...
# pmyexp <- "FE0001_BaselineR03SI"
# pinputexps <- "DR0001_BaselineR03SI"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR03SI", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR03SI", "DT0001_BaselineR03SI" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR03SI", "CA0001_BaselineR03SI" )
  FE_historia_guantesblancos( "FE0001_BaselineR03SI", "DR0001_BaselineR03SI" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BaselineR03SI", "FE0001_BaselineR03SI" )
  
  HT_tuning_guantesblancos( "HT0001_BaselineR03SI", "TS0001_BaselineR03SI" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BaselineR03SI", c("HT0001_BaselineR03SI","TS0001_BaselineR03SI") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BaselineR03SI", "FE0001_BaselineR03SI" )
  
  HT_tuning_guantesblancos( "HT0002_BaselineR03SI", "TS0002_BaselineR03SI" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BaselineR03SI", c("HT0002_BaselineR03SI", "TS0002_BaselineR03SI") )
...
#corrida_guantesblancos_202109( "gb01_BaselineR03SI" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BaselineR03SI" )
