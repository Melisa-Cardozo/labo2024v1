...
# pmyexp <- "CA0001_BaselineR08"
# pinputexps <- "DT0002_BaselineR08"
# pserver <- "local"
...
# pmyexp <- "DR0001_BaselineR08"
# pinputexps <- "CA0001_BaselineR08"
# pserver <- "local"
...
# pmyexp <- "FE0001_BaselineR08"
# pinputexps <- "DR0001_BaselineR08"
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR08", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR0", "DT0001_BaselineR08" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR08", "CA0001_BaselineR08" )
  FE_historia_guantesblancos( "FE0001_BaselineR08", "DR0001_BaselineR08" )
  
  TS_strategy_guantesblancos_202109( "TS0001_BaselineR08", "FE0001_BaselineR08" )
  
  HT_tuning_guantesblancos( "HT0001_BaselineR08", "TS0001_BaselineR08" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BaselineR08", c("HT0001_BaselineR08","TS0001_BaselineR08") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BaselineR08", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BaselineR08", "DT0001_BaselineR08" )
  
  DR_drifting_guantesblancos( "DR0001_BaselineR08", "CA0001_BaselineR08" )
  FE_historia_guantesblancos( "FE0001_BaselineR08", "DR0001_BaselineR08" ) 
  
  # Ya tengo corrido FE0001 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0002_BaselineR08", "FE0001_BaselineR08" )
  
  HT_tuning_guantesblancos( "HT0002_BaselineR08", "TS0002_BaselineR08" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BaselineR08", c("HT0002_BaselineR08", "TS0002_BaselineR08") )
...
#corrida_guantesblancos_202109( "gb01_BaselineR08" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BaselineR08" )